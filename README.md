...
- [x] Explain what a token is used for.
  ...
  Answer: token is using for login to the page by post request to the api. 

- [x] What steps can you take in your web apps to keep your data secure?

  Answer: We can secure our Data by create the Privateroute the Privateroute if has no login will never get into the page or data. it will push to the page that we are setting for that route sent like the login route

- [x] Describe how web servers work.

  Answer: Web server processes incomming network requests over HTTP and servaql other related protocols. The primary function of web server is to store, processes and deliver web pages to clients

- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

  Answer: PUT method and DELETE
